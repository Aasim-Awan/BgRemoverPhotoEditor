...
import com.photoTools.bgEraser.frame.FrameEntity
import com.photoTools.bgEraser.multitouch.MultiTouchEntity
...
class ResultContainer private constructor() {
    ...
    fun putImage(key: String, bitmap: Bitmap) {
        Log.d("ImageStorage", "Storing image with key: $key")
        mDecodedImageMap[key] = bitmap
    }

    fun getImage(key: String): Bitmap? {
        Log.d("ImageStorage", "Retrieving image with key: $key")
